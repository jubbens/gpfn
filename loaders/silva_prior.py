from breeding_schemes.silva import Silva
...
class SilvaGenerator(Prior):
    def __init__(self, base_population_generator,
                 ...
                 family_size_min=16, family_size_max=32,
        ...
        super(SilvaGenerator, self).__init__(use_cache=use_cache, cache_dir=cache_dir,
        ...
        self.family_size_interval = [family_size_min, family_size_max]
    ...
    def __getitem__(self, idx):
        ...
        gen = Silva(num_families=sample_interval(self.num_families_interval),
                    family_size=sample_interval(self.family_size_interval),
