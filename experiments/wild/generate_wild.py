...
parser.add_argument('--batch_size', type=int, required=False, default=8, help='Used to determine eval schedule')
...
gen = SimPopGenerator(pop_max_size=args.pop_max_size,
                      num_base_min=200, num_base_max=args.pop_max_size,
                      num_samples=args.num_samples, feature_max_size=args.feature_max_size,
                      feature_selection=args.feature_selection,
                      verbose=False, use_cache=True, cache_dir=args.output_dir)
...
if args.mpi:
    ...
    batch_size = 1
    loader = DataLoader(gen, batch_size=batch_size, num_workers=args.num_threads, shuffle=False)
